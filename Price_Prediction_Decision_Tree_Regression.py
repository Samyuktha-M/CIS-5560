...
# MAGIC %md
# MAGIC <a href="http://www.calstatela.edu/centers/hipic"><img align="left" src="https://avatars2.githubusercontent.com/u/4156894?v=3&s=100"><image/>
# MAGIC </a>
# MAGIC <img align="right" alt="California State University, Los Angeles" src="http://www.calstatela.edu/sites/default/files/groups/California%20State%20University%2C%20Los%20Angeles/master_logo_full_color_horizontal_centered.svg" style="width: 360px;"/>
# MAGIC 
# MAGIC #    CIS5560 Term Project Tutorial

# COMMAND ----------

# MAGIC %md
# MAGIC ------
# MAGIC #### Authors: Farnood Rahbar Far, Samyuktha Muralidharan, Sanjana Boddireddy, Savita Yadav
# MAGIC 
# MAGIC #### Instructor: [Jongwook Woo](https://www.linkedin.com/in/jongwook-woo-7081a85)
# MAGIC 
# MAGIC #### Date: 05/10/2021
...
# Split the data for Decision Tree regression
...
dtparamGrid = (ParamGridBuilder().addGrid(dt.maxBins, [24, 50]).addGrid(dt.minInfoGain,[0.0, 0.7]).build())
